    ...
    <section id="alumno-form">
        ...
        >
            ...
            <el-form-item
                label="Curso Name"
                prop="curso"
                :error="errors.get('curso')"
            >
                <el-input
                    v-model="form.curso"
                    suffix-icon="el-icon-edit"
                    @change="errors.clear('curso')"
                />
            </el-form-item>
        </el-form>
        <div
...
export default {
    ...
    data() {
        return {
            ...
            rules: {
                name: [
                    { required: true, message: 'alumno name is required' },
                ],
            },
        }
    },
        ...
        saveSubmit() {
            this.$refs.form.validate((valid) => {
                if (valid) {
                    ...
                    this.errors.clear()
                    let action = this.form.id ? alumnoApi.update : alumnoApi.create
